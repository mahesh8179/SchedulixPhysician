...
<br>
<form action="alertdeveloper.php" method="POST"> 
<div style="text-align:center;"> 
    <h2> <h1> Schedule Date and Time</h2>
...
<center>
    <div >
         <button type="submit" class="service" onclick="listView()">Schedule the service</button>
    </div>
</center>
</form>
<script>
