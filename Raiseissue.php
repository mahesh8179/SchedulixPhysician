...
<body>
        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0">
                <a href="index.html" class="navbar-brand">
                    <h1 class="m-0 text-uppercase text-primary"><img src="img/doc_logo.png" alt="Logo" style="width: 80px;margin-right: 10px;height: 85px;position: fixed;left: 0%;top: 0%;"></i>Schedulic Physician</h1>
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <a href="Raiseissue.php" class="nav-item nav-link active">Staff issues</a>
                        <a href="serviceadmin.php" class="nav-item nav-link ">Staff</a>
                        <a href="Cfetch.php" class="nav-item nav-link">Customercomplaints</a>
    ...
    <!-- Navbar End -->
    <img src="img/doct img 9.jpg"/>   
    <!-- <h1 style="text-align:center;        padding-left: 128px; font-size: 16px;">RAISE ISSUE</h1> -->
<div id="btnContainer">
<script>
...
<?php
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc())
            {
                ...
                echo '<div class="row det" style="width: 563px; ">';
               echo '<div class="column" >';
              
               echo '<h2>Name  <span class="name" style="    color: black;padding-left: 168px;">: '. $Name.'</span></h2>';
               echo '<h2>Specification <span class="exp">: '. $Specification.'</span></h2>';
               echo '<h2>Contact number <span class="staff">: '.$Contact.'</span> </h2>';
                echo '<h2>Email <span class="tname">: '.$Email.'</span></h2>';
               echo '<h2>Idno <span class="idno">: '.$Idno.'</span> </h2>';
               echo '<h2>Address <span class="contact">: '.$Address.'</span> </h2>';
               echo '<h2>Issue <span class="address">: '.$Issue.'</span></h2>';
