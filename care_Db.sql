...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 24, 2024 at 08:15 AM
...
--
CREATE DATABASE IF NOT EXISTS `nurturecare` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `nurturecare`;
...
('root', '[{\"db\":\"nurturecare\",\"table\":\"asignup\"},{\"db\":\"nurturecare\",\"table\":\"developers\"},{\"db\":\"nurturecare\",\"table\":\"signup\"},{\"db\":\"nurturecare\",\"table\":\"user\"},{\"db\":\"nurturecare\",\"table\":\"request\"},{\"db\":\"nurturecare\",\"table\":\"category\"},{\"db\":\"nurturecare\",\"table\":\"complaint\"}]');
...
('root', '2024-03-24 07:15:22', '{\"Console\\/Mode\":\"collapse\"}');
