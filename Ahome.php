...
<body>
    ...
    <div id="btnContainer">
                        ...
                        <main style="width: 500px;      margin-top: -925px;margin-left: -4px;">
...
if ($result->num_rows > 0) {
    ...
    echo '<select name="specification" style="width: 342px; height: 54px;border: 1.5px solid #2a5af8ab;border-radius: 6px; color:grey;">';
